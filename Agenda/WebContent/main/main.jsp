    ...
    <section id="fullpage">
        ...
        <section class="section second">
            ...
            <div class="menu-wrap">
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='#'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='${pageContext.request.contextPath}/pharmacy_map/pharmacy_map.jsp'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='${pageContext.request.contextPath}/qna/index.jsp'">
