...
<body>
	...
	<section class="section second area">
		<div class="second-area-01">
			<p>JOIN US !</p>
			<span>지금 당장 Agenda에 가입하세요</span>
		</div>
		
		<div class="second-area-02">
			<div class="second-menu-wrapper">
				<div class="second-menu" onClick="location.href ='${pageContext.request.contextPath}/MainController?command=notice'">
				...
				<div class="second-menu" onClick="location.href ='${pageContext.request.contextPath}/qna/index.jsp'">
			...
			<div class="second-menu-wrapper">
				<div class="second-menu" onClick="location.href ='${pageContext.request.contextPath}/MainController?command=mediSearch'">
					<svg width="50" height="50" viewBox="0 0 197 197" fill="none"
							xmlns="http://www.w3.org/2000/svg">
								...
								fill="#525252" stroke="black" stroke-width="2" />
				...
				<div class="second-menu" onClick="location.href ='${pageContext.request.contextPath}/MediLockerRegistController?command=mediLocker'">
				...
				<div class="second-menu" onClick="location.href ='${pageContext.request.contextPath}/pharmacy_map/pharmacy_map.jsp'">
