    ...
    <section id="fullpage">
        ...
        <section class="section second">
            ...
            <div class="menu-wrap">
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='../MainController?command=mediSearch'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='../MainController?command=mediLocker'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='../MainController?command=findPharm'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='../MainController?command=notice'">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='../MainController?command=qna'">
