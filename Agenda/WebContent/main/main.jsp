    ...
    <section id="fullpage">
        ...
        <section class="section second">
            ...
            <div class="menu-wrap">
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='${pageContext.request.contextPath}/MainController?command=mediSearch'">
                            <svg width="50" height="50" viewBox="0 0 197 197" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='${pageContext.request.contextPath}/MainController?command=mediLocker'">
                            <svg width="50" height="50" viewBox="0 0 203 203" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M58.7083 133.242V133.742H59.2083H123.064H123.564V133.242V122.599V122.099H123.064H59.2083H58.7083V122.599V133.242Z" fill="black" stroke="black"/>
                                <path d="M58.7083 90.6715V91.1715H59.2083H144.349H144.849V90.6715V80.0288V79.5288H144.349H59.2083H58.7083V80.0288V90.6715Z" fill="black" stroke="black"/>
                                <path d="M58.7083 111.957V112.457H59.2083H144.349H144.849V111.957V101.314V100.814H144.349H59.2083H58.7083V101.314V111.957Z" fill="black" stroke="black"/>
                                <path d="M136.263 15.8195L136.117 15.6731H135.91H37.9231H37.4231V16.1731V186.455V186.955H37.9231H165.635H166.135V186.455V45.8873V45.6801L165.988 45.5337L136.263 15.8195ZM134.196 47.601V30.2203L151.582 47.601H134.196ZM123.064 59.2383H154.492V175.313H49.0657V27.3051H122.564V58.7383V59.2383H123.064Z" fill="black" stroke="black"/>
                            </svg>
                        </div>
                    </div>
                    <div class="description">
                ...
                <div class="menu">
                    <div class="menu-icon">
                        <div class="menu-icon-inside" onClick="location.href ='${pageContext.request.contextPath}/MainController?command=findPharm'">
