	...
	<section class="first">
		<div id="TempPw">
			...
			<div class=TempPw__bottom>
				<form name="idfindscreen" action="loginForm.jsp" method="post">
...
<!-- 							<input type="text" placeholder="인증번호를 입력해주세요" name="TempPw" required> -->
<!-- 						</div> -->

						<div class="TempPw__submit__pw">
							<div class="Change__Pw">변경하실 비밀번호를 입력해주세요</div>
							<input type="text" placeholder="변경하실 비밀번호를 입력해주세요" name="Change_Pw" required />
						</div>
						...
						<div>
							<div>
								<button class="TempPw__submit__button" type="submit" value="TempPwbtn" onclick="main/main.jsp">비밀번호 변경하기</button>
							</div>
						</div>
					</div>
				</form>
