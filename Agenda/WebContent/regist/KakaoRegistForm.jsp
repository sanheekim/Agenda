...
<script type="text/javascript">
	...
	function idCheck() {
		...
		if (doc.value.trim() == "" || doc.value == null) {
			...
			open("${pageContext.request.contextPath}/KakaoRegistController?command=idcheck&member_id="+doc.value,
					"",
...
<body>
	...
	<br><br><h2>아괜다 계정 정보를 입력해주세요.</h2><br><br>
		...
		<input type="hidden" name="command" value="Kakaoregistres"/>
		<table>
	...
	function sendEmail() {
		...
		$.ajax({
			url: "/Agenda/KakaoRegistController?command=emailValid&email="+email,
			type: "POST",
