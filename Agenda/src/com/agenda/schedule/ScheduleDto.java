...
public class ScheduleDto {
	...
	public ScheduleDto(String member_id) {
	...
	public ScheduleDto(int pres_no, String member_id) {
		this.pres_no = pres_no;
		this.member_id = member_id;
	}

	public ScheduleDto(int sche_no, int pres_no,String member_id, String sche_content, String sche_time, String sche_regdate) {
